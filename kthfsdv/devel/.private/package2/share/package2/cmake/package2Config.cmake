...
if("TRUE" STREQUAL "TRUE")
  set(package2_SOURCE_PREFIX /home/neo/kthfsdv/src/exc1/package2)
  set(package2_DEVEL_PREFIX /home/neo/kthfsdv/devel/.private/package2)
  set(package2_INSTALL_PREFIX "")
  set(package2_PREFIX ${package2_DEVEL_PREFIX})
else()
  set(package2_SOURCE_PREFIX "")
  set(package2_DEVEL_PREFIX "")
  set(package2_INSTALL_PREFIX /home/neo/kthfsdv/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/neo/kthfsdv/src/exc1/package2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/neo/kthfsdv/devel/.private/package2/lib;/home/neo/kthfsdv/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND package2_EXPORTED_TARGETS ${${package2_dep}_EXPORTED_TARGETS})
endforeach()
